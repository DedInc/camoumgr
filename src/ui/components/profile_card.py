...
class ProfileCard(ctk.CTkFrame):
    def __init__(self, parent, profile: Profile, launch_cb, delete_cb):
        ...
        self.launch_btn.grid(row=0, column=2, rowspan=2, padx=(0, 15))
        ...
        self.delete_btn.grid(row=0, column=3, rowspan=2, padx=(0, 20))
